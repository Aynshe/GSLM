...
namespace GameStoreLibraryManager.Luna
{
    public class LunaBrowserForm : Form
    {
        ...
        private readonly string _startUrl = "https://luna.amazon.fr/library";
        private WebView2 _webView;
        private readonly string _userDataFolder;
        private readonly string _cookieStorePath;

        public LunaBrowserForm(bool fullscreen = true)
        {
        ...
        private async void OnLoadAsync(object sender, EventArgs e)
        {
            ...
            // Try restore cookies before first navigation
        ...
        {
            var list = await _webView.CoreWebView2.CookieManager.GetCookiesAsync("https://luna.amazon.fr");
