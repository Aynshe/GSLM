using System;
using System.IO;
using GameStoreLibraryManager.Steam.ValveKeyValue.Abstraction;
using GameStoreLibraryManager.Steam.ValveKeyValue.Deserialization;
using GameStoreLibraryManager.Steam.ValveKeyValue.Deserialization.KeyValues1;
